...
namespace mad_icp
{
    ...
    public:
         ...
         * @param pcl_out
         */
        // void Process(const livox_ros_driver::CustomMsg::ConstPtr &msg, std::vector<Eigen::Vector3d> &, std::vector<double> &);
         ...
         * @param pcl_out
         */
        void Process(const sensor_msgs::PointCloud2::ConstPtr &msg, std::vector<Eigen::Vector3d> &, std::vector<double> &);
    ...
    private:
        ...
        std::vector<Eigen::Vector3d> cloud_vec;
